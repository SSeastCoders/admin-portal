...
describe('RegisterComponent', () => {
  ...
  it('should generate user fields', () => {
    ...
    expect(component.register.password).toEqual(component.registerForm.get('password').value);
    expect(component.register.username).toEqual(component.registerForm.get('username').value);
    expect(component.register.email).toEqual(component.registerForm.get('email').value);
    expect(component.register.firstName).toEqual(component.registerForm.get('firstName').value);
    expect(component.register.lastName).toEqual(component.registerForm.get('lastName').value);
  });
