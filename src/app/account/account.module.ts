...
@NgModule({
  imports: [AccountRoutingModule, CommonModule, FormsModule, ReactiveFormsModule, MaterialModule],
  declarations: [AccountRoutingModule.components, DeleteModalComponent, EditModalComponent, UserSearchModalComponent]
})
