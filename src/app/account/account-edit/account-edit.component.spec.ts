...
describe('AccountEditComponent', () => {
  ...
  beforeEach(() => {
    ...
    component.accountForm.patchValue({"accountType": "SAVING",
                                      "nickName": "NICKNAME"});
    for(let i = 0; i<4; i++){
  ...
  it('should build form', () => {
    ...
    expect(component.accountForm.get('accountType').value).toEqual(component.account.accountType);
    expect(component.accountForm.get('nickName').value).toEqual(component.account.nickName);
    expect(component.accountForm.get('users').value.length).toEqual(component.account.users.length);
  ...
  it('should get properties', () => {
    expect(component.accountType).toEqual(component.accountForm.get('accountType'));
